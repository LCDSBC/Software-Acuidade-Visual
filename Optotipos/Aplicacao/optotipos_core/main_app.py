...
class OptotiposApp:
    ...
    def apply_window_mode(self) -> None:
        if self.config.get_bool("Exibicao.txt", "TelaCheia", True):
    ...
    def render(self) -> None:
        ...
        render_test(self.canvas, self.current_test, self.calibration, self.state, self.render_options())
        self.status_text.set(f"{self.current_test.name} | {self.calibration.distance_m:g} m")
